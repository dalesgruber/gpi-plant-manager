...
- [ ] **Move more inline `<script>`/`<style>` → `/static`:** `index.html` (161-line `<style>`, zero Jinja), `leaderboards.html` (~145 lines JS, zero Jinja), `settings.html` (~578 lines JS, one Jinja value `PROD_MIN`). *Risk: Low–Medium.*
